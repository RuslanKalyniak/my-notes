...
export default function StepsSmall({ stepsCount = 4, animationDuration = 5 }) {
    ...
    return (
        <div className={styles.footsteps}>
            {Array.from({ length: steps }, (_, index) => {
                ...
                const delay = (index * animationDuration) / (steps * 1.35);
                ...
                return (
                    ...
                    >
                        ...
                        >
                            <svg fill="#000000" version="1.1" xmlns="http://www.w3.org/2000/svg" width="15px" height="30px" viewBox="0 0 515.458 515.458">
